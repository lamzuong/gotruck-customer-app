      ...
      <View style={styles.container}>
        ...
        <View style={styles.viewInput}>
          <View style={styles.input}>
            <TextInput style={styles.txtInput} placeholder="Nhập tin nhắn..." numberOfLines={99} />
          </View>
          <Ionicons name="send" size={30} color={stylesGlobal.mainGreen} style={styles.iconSend} />
        </View>
      </View>
    </>
  );
